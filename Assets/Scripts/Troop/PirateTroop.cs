...
public class PirateTroop : TroopBase {
    ...
    private List<string> TroopEquipmentAppearanceTags = new() { "RightHandSword", "RightHandPistol" };
    ...
    public override bool EquipItem(IEquipment item) {
        hasSword = item.IsWeapon && !item.IsRangeWeapon;
        hasPistol = item.IsWeapon && item.IsRangeWeapon;
    ...
    public override bool RemoveItem(EquipmentType equipmentType) {
        ...
        if (equipment != null) {
            hasSword = (!equipment.IsWeapon || equipment.IsRangeWeapon) && hasSword;
            hasPistol = (!equipment.IsWeapon || !equipment.IsRangeWeapon) && hasPistol;
        }
    ...
    public override void UpdateAppearance() {
        ...
        if (IsRange) {
            tagsToActive.Add("RightHandPistol");
